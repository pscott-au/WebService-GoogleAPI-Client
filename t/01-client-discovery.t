...
subtest 'Discovery methods with User Configuration'  => sub {
    ...
    if ( -e $default_file && $user) 
    {
        ...
        ok ( scalar( $gapi->list_of_available_google_api_ids() ) > 120, 'WebService::GoogleAPI::Client->list_of_available_google_api_ids() returned an ARRAY with more than 120 Google Service API IDs');
