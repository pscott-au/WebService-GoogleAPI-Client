...
isa_ok my $jwt = WebService::GoogleAPI::JWT->new, ['WebService::GoogleAPI::JWT'], 'empty object creation';
...
for my $scopes ( c('/a/scope', '/b/scope'), [qw+ /a/scope /b/scope +] ){
  ok $jwt = WebService::GoogleAPI::JWT->new( client_email => $client_email,
                                 issue_at => '1429812717',
...
$jwt = WebService::GoogleAPI::JWT->new( client_email => $client_email,
...
# predefine
$jwt = WebService::GoogleAPI::JWT->new( scopes => c('/scope/a/', '/scope/b/'));
...
like dies {
  WebService::GoogleAPI::JWT->new( from_json => "$testdir/load0.json" ),
}, qr/Your JSON file import failed.*/, 'dies on file load failure';


$jwt = WebService::GoogleAPI::JWT->new( from_json => "$testdir/load1.json" );
